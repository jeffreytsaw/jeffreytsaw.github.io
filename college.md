...
- *Read [this](https://mitadmissions.org/blogs/entry/50_things/)* - then read it again. It's amazingly relevant.
...
-  **☆** 33-141: Physics I for Engineering Students
    - Very good class, Anderson genuinely cares about his students, it's a nice way to ease into college type classes.
    - I liked the way Newton's laws are taught, Anderson is very thorough. The change of reference frame approach to collisions is also interesting.
- 27-100: Engineering Materials of the Future
    ...
    - Virtually no work though, homework answers are given in recitation, and you do get to make a ring in the last lab.
-  **☆** 79-104: Global Histories -The Rise and Fall of the British Empire
    ...
    - Covered Britiish Imperialism from 17th century to 20th century. Probably the first time I enjoyed listening to someone talk about history.
...
- ☆ 15-112: Fundamentals of Programming and Computer Science
    ...
    - Final project is a great experience building something cool from scratch.
- 18-100: Intro to Electrical and Computer Engineering
    ...
    - Go to SI and/or sign up for EXCEL. Seriously it will save your life. This and the 50% of marks lossed back for doing exam corrections.
    - Labs were brutal. Go to lab early, so you can finish early. Nothing is worse than finishing at 11pm
- 21-259: Calculus in 3 Dimensions
    ...
    - Should have taken 21-268 or waited to take 21-269, I wanted more rigor
...
- 21-101: Freshman Math Seminar - Fractals and Chaos (mini)
    - I took this cause I missed rigorous proof-based math.
...
**Workload:** 52.5 units - moderate, majority of the work came from 112
...
- 15-122: Principles of Imperative Computation
    - Felt more like an intro to real CS, you learn search, sorts, and data structures
...
- 33-142: Physics II for Engineering Students
    - Lectures were pretty confusing, so reading the textbook was honestly a life saver 
    - Content moves pretty quick and the exams and final is pretty much your entire grade
- 21-127: Concepts of Mathematics
    - A first class in proof based math, covers proof methods, sets, functions, relations, and basic number theory and combinatorics.
    - Pretty much review for anyone that's done competition math before, tough if you've never written a proof.
...
-  **☆** 15-213 - Introduction to Computer Systems
    ...
    - Lectures are recorded and pretty good (maybe correlated)
...
- **☆** 18-290 - Signals and Systems
    - Sankaranarayanan is a great lecturer and made a lot of the scary ideas in signals pretty intuitive. He made me want to take a deeper signals course.
    - Fourier and Laplace transforms look scary but it's just math, don't worry 21-122 prepared you well.
- 18-202: Mathematical Foundations of ECE
    ...
    - The only saving grace is that this course can be used as a prereq for any course that requires 21-241, so ECE kids can take 10-301 (intro to ML)
- 33-211: Physics III: Modern Essentials
    ...
    - I did a bit of special relativity in IB Physics so I thought it'd be review, but this really goes in depth into the transformations and using the invariants. The stuff about general relativity, time dilation, and the skim of QM was also interesting
...
**Reflection:** I wanted to take it a little easier after the fall semester, so I decided not to overload. I also wanted to bang a bunch of my ECE requirements out early so I wouldn't have to worry as I prepared to study abroad next spring. I cannot stress enough how great 15-213 is as a class, you really learn how to design code and methodically debug. It's also a class you should try and work alone as much as possible, there's tons of students who get caught cheating every semester.
...
- TA: 15-213/15-513/18-613 Introduction to Computer Systems
    ...
    - Trying to read, understand, and help debug other people's code is horrible. Following a line of logic that isn't yours is extremely difficult. Please understand the more code you write the harder it will be for a TA to pinpoint the mistake.
    - Style grading was tedious, especially when there were 40 of them to do. You see some ridiculous code (I'm looking at you, Master's students.)
...
- SI: 33-141: Physics I For Engineering Students
    ...
    - Seeing the same students at every session is my favourite part of this job. 
- **☆** 18-341: Logic Design and Verification
    ...
    - Debugging EDGE for USB was a nightmare. Finishing USB was better than finishing lab 5 for 18-240
- **☆** 18-349: Introduction to Embedded Systems
    - Rowe is not a great lecturer, lectures only matter for exams really.
    - The code you write interfaces almost directly with hardware and MMIO devices so writing the drivers for those was pretty cool.
...
- **☆** 21-325: Probability Theory
    ...
    - Poisson processes and Queuing theory is difficult. If you get it, please explain it to me.
...
**Reflection:** 18-341 and 18-349 is a pretty rough combination. Make sure you have a good partner for 18-349. Material in both these classes was great if you like hardware/systems. I really enjoyed 21-325, I really like the abstract math part, and it was definitely fun to think in a write-proof kind of way, which is surprisingly different from writing code. I had to petition the department so I could count it for my probability/stat requirement, but it was definitely worth it, and I suggest others do it too if you liked 21-127. Being an SI leader was a lot more work than being an EXCEL leader, but I definitely started looking forward to the sessions.
...
- ELEC0029: Electronic Devices and Nanotechnology
    ...
    - The quantum physics half of the course was weird. They didn't go in depth enough into the math of inherently mathy concepts like tunneling.
...
**Workload:** Virtually None. UK universities have finals worth 70-100% of the final grade and with COVID a lot of assignments were cancelled.

**Reflection:** Studying abroad was a lot of fun, before coronavirus of course. It was nice to take a break from CMU and the environment, and have an opportunity to explore a new city. I had a lot of fun playing competitive hockey again, until, unfortunately, our season was cut short. Coronavirus pushed a lot of my exams back and Developmental Psych cut their final, Accounting changed their exam to a written assignment, and the 2 ELEC classes had online exams. No homework throughout the semester was a plus at the time, but cramming meant I probably retained less. I did have time before exams to informally take [10-701](http://www.cs.cmu.edu/~lwehbe/10701_S20/), so that was a huge plus for me as I've been wanting to learn ML for a while.
...
- Credit Suisse: Technology Analyst Intern
    ...
    - The 12 hour time difference meant I had to work 9pm - 5am.  Was rough.
    ...
    - Fintech has an interesting appeal over traditional software jobs, the focus in fintech is on how it impacts the business, which is interesting to see how scope affects the software you build.
